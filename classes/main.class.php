      ...
      if (!empty($dataarray)) {
        if (is_array($dataarray)) {
          if ($ReplDB->keyExists($keyName) == false) {
            ...
            echo $ReplDB->setKey($keyName, $newDataArray);
          } else {
            return "KEY_EXISTS";
          }
        } else {
